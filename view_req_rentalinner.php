...
<div class="navbar1">
    ...
    while ($row = mysqli_fetch_assoc($result )) {
        ...
        ?>
        <td>
        <a class='btn_listing' id='Quotepricebutton' href='view_quoteprice_rental.php?id=<?php echo $row['id']; ?>'> View & Quote Price</a>
        <a class='btn_listing' onclick="notinterested()"> Not Interested</a>
