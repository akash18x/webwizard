...
<body>
    ...
    <section class="dashboard">
        ...
        <div class="top">
            ...
            <!-- <p>Food Donate</p> -->
            <p  class ="logo" >Feed <b style="color: #06C167; ">ON</b></p>
             <p class="user"></p>
        ...
        <br>
         ...
         <option value="mumbai_1">Nerul</option>
          <option value="mumbai_2">Uran</option> 
          <option value="mumbai_3">Vashi</option> 
          <option value="mumbai_4">Panvel</option> 
