...
<form action="purchase_requisition.php"  id="myForm" method="POST" class="purchaseform">
<div class="purchase_heading"><h3 class="purchase_requisition_heading">Purchase Requisition For New Equipment</h3></div>
    ...
    <div class="purchase-requisition">
        ...
        <button class="epc-button" id="btnEdit" type="submit" name="submit">Submit</button>        <br>
    </div>
</form>
<!-- <div class="outercard"> -->
